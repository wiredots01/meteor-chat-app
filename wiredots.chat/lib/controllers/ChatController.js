 ...
 * Wiredots as my meteor username/module, and
 * ChatController for my controllername
 */
Namespace('Wiredots.ChatController');
 ...
 */
Wiredots.ChatController = Meteoris.Controller.extend({
    /*
    ...
    getAll: function() {
        return Wiredots.Chat.find(this.getCriteria(), this.getSortLimit());
    },
    ...
    post: function(t) {
        ...
        Wiredots.Chat.insert(doc, function(err, _id) {
            if (err) {
