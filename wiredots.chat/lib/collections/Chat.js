 ...
 */
Namespace('Wiredots.Chat');

/*
 * create new mongo collection
 * in my case my collection name will be "wiredots_chat"
 * this is to avoid crash between another collection name called "chat"
 */
Wiredots.Chat = new Mongo.Collection("wiredots_chat");
...
Wiredots.Chat.attachSchema(schemas);
